...
- **Help page: new "Latin-script languages — always permitted" section.** Documents the broader set of Latin-script languages whose URLs always load normally, beyond the ~26 shown in the options panel. Grouped into European, Africa/Oceania/Americas, and multi-script edge cases (Bosnian, Azerbaijani, Uzbek, Turkmen, Kazakh, Kurdish). The options panel's always-permitted language list now includes a link to this section.
